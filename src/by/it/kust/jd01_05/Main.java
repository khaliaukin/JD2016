...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Задание 5
        System.out.println("Задание 5: \nВычисление функции (циклическое вычисление с разветвлением). Распечатаем величину и результат:");
        Task5.calculate();

        //Задание 6
        System.out.println("Задание 6: \nПо функции сформировать одномерный массив из 20-40 элементов при изменении аргумента в заданном интервале:");
        double[] m = Task6.getArray();
        Task6.arrayPrint(m, "arr", 6);
        Task6.newArray(m);

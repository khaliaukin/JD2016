...
public class A3 {
    ...
    static boolean Glasnaya(String word)
    {
        ...
        //возвратим true если гласная в начале и в конце
    ...
    public static void main(String[] args) {
        ...
        //Паттерн для слов с 1 буквой и более [а-яА-ЯёЁ]+
        Pattern p = Pattern.compile("[а-яА-ЯёЁ]+");

        //Получаем matcher - эта структура умеет находит слова по паттерну
        Matcher m = p.matcher(text);

        int counter = 0;

        //пока находятся слова, мы подсчитываем число подходящих под проверку
        while (m.find())
